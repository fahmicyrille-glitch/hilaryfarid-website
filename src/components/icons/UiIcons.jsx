...
/* Drapeaux en SVG plutôt qu'en emoji : Windows n'a pas les glyphes de drapeaux
   et affiche "FR"/"GB" à la place. */

export const FlagFR = ({ className = "w-5 h-5" }) => (
  <svg viewBox="0 0 640 480" className={className} role="presentation" aria-hidden="true">
