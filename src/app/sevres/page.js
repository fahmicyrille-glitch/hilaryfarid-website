...
const SEVRES_SCHEMAS = [
  ...
  },
  {
    ...
    mainEntity: [
      ...
      {
        "@type": "Question",
        name: "Proposez-vous le drainage Renata França à Sèvres ?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Oui, Hilary Farid propose des séances de drainage Renata França au cabinet de Sèvres et à Paris 15. Il s'agit d'une technique manuelle spécifique, à distinguer du drainage lymphatique médical remboursé par la Sécurité sociale.",
        },
      },
    ],
  },
  ...
  return (
    <main>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(SEVRES_SCHEMAS) }}
      />
      ...
      <section className="relative h-[65vh] w-full overflow-hidden">
        <Image
          ...
          alt="Cabinet d'ostéopathie à Sèvres – Hilary Farid, 104 Grande Rue"
          fill
          priority
          sizes="100vw"
        ...
        <div className="absolute inset-0 bg-black/50 flex flex-col justify-center items-center text-center px-6">
          <FadeIn>
            <h1 className="text-4xl md:text-5xl font-semibold text-offwhite drop-shadow-lg">
              Cabinet d'Ostéopathie – Sèvres (92)
            </h1>
          ...
          <SevresNav>
            ...
            <SlideUp>
              <section id="cabinet" className="bg-white rounded-2xl shadow-sm border border-light/70 p-6 md:p-8">
                <h2 className="text-3xl font-semibold text-primary text-center">Un cadre apaisant pour des soins de qualité</h2>
                ...
                <div className="grid md:grid-cols-3 gap-4 md:gap-6">
                  {[
                    { file: "cabinet-sevres-1.webp", label: "Salle de consultation du cabinet d'ostéopathie à Sèvres – Hilary Farid" },
                    { file: "cabinet-sevres-2.webp", label: "Table de soin ostéopathie au cabinet de Sèvres – Hilary Farid" },
                    { file: "cabinet-sevres-3.webp", label: "Salle d'attente du cabinet d'ostéopathie Sèvres – 104 Grande Rue" },
                  ].map((img, i) => (
                ...
                <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                  <div>
                    ...
                    <p className="text-graywarm text-base md:text-lg leading-relaxed mt-6">
                      Ostéopathe DO diplômée, je vous accueille au cabinet de Sèvres dans une approche globale, douce et personnalisée.
                      Mon objectif est de comprendre l'origine de vos douleurs pour agir de manière durable, tout en respectant votre histoire et votre corps.
                    </p>
                    <p className="text-graywarm text-base md:text-lg leading-relaxed mt-4">
                      Formée aux techniques structurelles, viscérales, crâniennes et tissulaires, j'accompagne également les femmes enceintes, les nourrissons ainsi que les sportifs dans leur récupération physique.
                    </p>
                  </div>
                  <div className="flex justify-center">
                    <div className="relative w-full max-w-sm h-[450px] rounded-xl shadow-xl overflow-hidden">
                      <Image
                        src="/hilary.webp"
                        alt="Hilary Farid, ostéopathe D.O. au cabinet de Sèvres"
                        fill
                        className="object-cover"
                        loading="lazy"
                ...
                <div className="mt-8 grid md:grid-cols-2 gap-6 text-left">
                  <article className="p-6 rounded-xl bg-offwhite/50 border border-light/80 shadow-sm">
                    ...
                    <p className="text-graywarm italic text-sm md:text-base leading-relaxed">
                      "Je consulte Hilary au cabinet de Sèvres depuis plusieurs mois pour des douleurs lombaires chroniques. Les résultats sont excellents, l'approche est douce et vraiment personnalisée."
                    </p>
                    <p className="mt-4 font-semibold text-primary text-sm">— Thomas L. (Ostéopathie, Sèvres)</p>
                  </article>
                  <article className="p-6 rounded-xl bg-offwhite/50 border border-light/80 shadow-sm">
                    <div className="flex text-amber-400 text-sm mb-3">★★★★★</div>
                    <p className="text-graywarm italic text-sm md:text-base leading-relaxed">
                      "J'ai découvert le drainage Renata França au cabinet de Sèvres. Résultats visibles dès la 1ère séance ! Hilary explique très bien en quoi c'est différent du drainage classique. Je reviens régulièrement."
                    </p>
                    <p className="mt-4 font-semibold text-primary text-sm">— Nadia B. (Drainage Renata França, Sèvres)</p>
                  </article>
                </div>
                <div className="mt-8">
                ...
                <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto mt-12 items-center">
                  ...
                  <div className="relative w-full h-[260px] md:h-[300px] rounded-lg overflow-hidden shadow-xl">
                    <Image
                      ...
                      alt="Salle de soin du cabinet d'ostéopathie à Sèvres – Grande Rue"
                      fill
                      loading="lazy"
                      sizes="(max-width: 768px) 90vw, 400px"
                      className="object-cover"
              ...
              <section id="acces" className="bg-white rounded-2xl shadow-sm border border-light/70 p-6 md:p-8">
                ...
                <div className="mt-10 rounded-lg overflow-hidden shadow-xl">
                  <iframe
                    ...
                    title="Localisation cabinet ostéopathie Sèvres – 104 Grande Rue"
                  />
                </div>
              </section>
            </SlideUp>
            ...
            <SlideUp>
              <section id="faq" className="bg-white rounded-2xl shadow-sm border border-light/70 p-6 md:p-8">
                <h2 className="text-3xl font-semibold text-primary text-center">FAQ – Cabinet d'ostéopathie à Sèvres</h2>
                <div className="mt-10 space-y-6">
                  <details className="bg-offwhite/80 border rounded-xl p-4 shadow-sm">
                    <summary className="font-semibold text-primary cursor-pointer">Quels types de patients sont accueillis au cabinet de Sèvres ?</summary>
                    <p className="mt-2 text-graywarm text-sm">Le cabinet accueille les adultes, les nourrissons, les femmes enceintes, les sportifs et les seniors pour des douleurs musculo-squelettiques, troubles fonctionnels ou un suivi de prévention.</p>
                  </details>
                  <details className="bg-offwhite/80 border rounded-xl p-4 shadow-sm">
                    <summary className="font-semibold text-primary cursor-pointer">Comment accéder au cabinet en transports en commun ?</summary>
                    <p className="mt-2 text-graywarm text-sm">Le cabinet est situé sur la Grande Rue de Sèvres, à proximité de la gare, du tramway T2 et de plusieurs lignes de bus. L'adresse exacte est : 104 Grande Rue, 92310 Sèvres.</p>
                  </details>
                  <details className="bg-offwhite/80 border rounded-xl p-4 shadow-sm">
                    <summary className="font-semibold text-primary cursor-pointer">Puis-je venir avec une poussette ou mon nourrisson ?</summary>
                    <p className="mt-2 text-graywarm text-sm">Oui, le cabinet est parfaitement adapté à l'accueil des nourrissons et des parents avec poussette.</p>
                  </details>
                  <details className="bg-offwhite/80 border rounded-xl p-4 shadow-sm">
                    <summary className="font-semibold text-primary cursor-pointer">Proposez-vous le drainage Renata França à Sèvres ?</summary>
                    <p className="mt-2 text-graywarm text-sm">Oui. Le drainage Renata França est une technique manuelle spécifique différente du drainage lymphatique médical remboursé par la Sécurité sociale. Les séances ont lieu au cabinet de Sèvres et à Paris 15.</p>
                  </details>
                </div>
              </section>
            </SlideUp>
