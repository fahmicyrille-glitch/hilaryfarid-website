            ...
            <FadeIn delay={0.2}>
              <div className="bg-white p-8 md:p-10 rounded-[2.5rem] shadow-2xl border border-light/50 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <a
                    href="https://calendly.com/VOTRE_LIEN_ICI"
                    target="_blank"
                    rel="noreferrer"
                    className="mt-10 flex items-center justify-center w-full bg-secondary text-white py-5 rounded-2xl font-bold text-lg shadow-[0_10px_20px_rgba(189,146,116,0.3)] hover:shadow-[0_15px_25px_rgba(189,146,116,0.4)] hover:-translate-y-1 transition-all duration-300"
                  >
