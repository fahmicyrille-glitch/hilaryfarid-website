export const metadata = {
  ...
  openGraph: {
    title: "Bienfaits du Drainage Renata França – Paris 15 & Sèvres | Hilary Farid",
    description:
      "Jambes lourdes, cellulite, rétention d'eau, immunité, grossesse… Découvrez tous les bienfaits du drainage Renata França par Hilary Farid.",
...
export default function BienfaitsLayout({ children }) {
  return <>{children}</>;
}
